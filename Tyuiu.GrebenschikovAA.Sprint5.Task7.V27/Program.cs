...
namespace Tyuiu.GrebenschikovAA.Sprint5.Task7.V27
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string name = "input";
            string path = $@"C:\datasprint5\{name}datafiletask7v18.txt";
            Console.Write("Новая строка: " + File.ReadAllText($@"C:\datasprint5\{name}datafiletask7v18.txt"));
            Console.ReadLine();
        }
    }
}
